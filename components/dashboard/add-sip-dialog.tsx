...
export default function AddSIPDialog({ open, onOpenChange, onSubmit }: AddSIPDialogProps) {
  ...
  const [availableFunds, setAvailableFunds] = useState<MutualFundPrice[]>([])
  const [isLoading, setIsLoading] = useState(false)
  const [searchQuery, setSearchQuery] = useState("")
  const [openCombobox, setOpenCombobox] = useState(false)
  const [selectedFund, setSelectedFund] = useState<MutualFundPrice | null>(null)
  ...
  const handleFundSelect = (fund: MutualFundPrice) => {
